...
> extends AbstractResultHandler {
  readonly #positive: POS | LazyResult<POS, [IOSchema | z.ZodVoid]>;
  ...
  constructor(params: {
    ...
    positive: POS | LazyResult<POS, [IOSchema | z.ZodVoid]>;
  ...
  /** @internal */
  public override getPositiveResponse(output: IOSchema | z.ZodVoid) {
